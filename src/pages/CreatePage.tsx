      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6">
        ...
        <div className="w-full max-w-xs space-y-3">
          {[
            ...
            { icon: Music, label: t("addMusic"), color: "bg-secondary" },
            { icon: Sparkles, label: t("addEffects"), color: "bg-ethiopia-green" },
          ].map((item) => (
            <button key={item.label} className="flex w-full items-center gap-4 rounded-xl bg-card border border-border p-4 transition-all hover:bg-muted">
